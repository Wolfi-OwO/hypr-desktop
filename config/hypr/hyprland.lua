...
-- Über die Shell statt playerctl: das Panel und die Tasten steuern damit
-- DASSELBE Player-Objekt. playerctl waehlt unabhaengig aus, was zu dem
-- Fall fuehrt, dass die Taste einen anderen Player trifft als der, den
-- das Panel anzeigt.
